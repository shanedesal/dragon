...
Look at the user's argument (the text provided after the prompt name, if any):

### If NO argument was given:

1. Use your tools to get the list of files that have been modified.
...
### If an argument WAS given (e.g., "what does this new screen do"):

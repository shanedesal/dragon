...
argument-hint: 'Use --all to scan everything, otherwise checks changed files'
---
...
2. Identify Dart files in scope.
   ...
   - Exclude generated files like *.g.dart, *.freezed.dart, and *.gen.dart.

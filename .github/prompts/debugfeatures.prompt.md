...
This prompt is intended to be run after `/addfeature` or anytime a user reports a bug to fix.
...
**If NO argument was given** (user just ran `/debugfeatures` with no text after it):
